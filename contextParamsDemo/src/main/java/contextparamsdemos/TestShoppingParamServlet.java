...
//@WebServlet("/TestShoppingParamServlet")
public class TestShoppingParamServlet extends HttpServlet {
    ...
    public TestShoppingParamServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("TestShoppingParamServlet");
